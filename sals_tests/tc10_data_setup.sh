...
postpaid_lkp_file=tc10_input_data_postpaid_lkp.txt
postpaid_lkp_input=input_data/$postpaid_lkp_file

recurring_lkp_file=tc10_input_data_recurring_lkp.txt
...
expected_output=$out_dir/tc10_result.expected
...
################################################################################
################################################################################
echo "tc10: 1. PCRF EDRs (input stream).."
rm -f $throttle_input
...
cat $data_dir/lookup_paymenttype/tc10_input_data_postpaid_lkp.txt
echo " "
echo "here is the recurring lookup we used.."
cat $data_dir/lookup_recurring/tc10_input_data_recurring_lkp.txt
echo " "
