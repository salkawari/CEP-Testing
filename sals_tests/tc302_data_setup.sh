...
echo " "
echo "test strategy:"
echo "we try various valid and invalid fonic throttle 100 events and make sure"
...
echo "Row7: a PREPAID throttle 100 event - it should be igonored"
...
echo "$msisdn7,PREPAID" >> $paymenttype_lkp_input
...
echo "Name#Test;Transaction_ID#${Time1}_${msisdn8}_${Quota_Name1}_${Quota_Next_Reset_Time1};Int_1#16;Type#$PaymentType1;Float_1#${Quota_Total1}.0;Int_3#0;Yes_No_1#;String_1#${Quota_Name1};MSISDN#${msisdn8};" >> $expected_output
