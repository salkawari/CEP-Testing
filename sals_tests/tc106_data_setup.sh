...
echo "cp input_data/a${throttle_file}.gz $data_dir/pcrf_files_postpaid/"
...
echo "cp input_data/a${throttle_file} $data_dir/pcrf_files_postpaid/b${throttle_file}.gz"
cp input_data/a${throttle_file} $data_dir/pcrf_files_postpaid/b${throttle_file}.gz
gzip input_data/a${throttle_file}
echo ""
...
echo "cp input_data/c${throttle_file}.gz $data_dir/pcrf_files_postpaid/"
cp input_data/c${throttle_file}.gz $data_dir/pcrf_files_postpaid/
echo ""
#######################################################################
...
echo "Name#Test;Transaction_ID#${Time1}_${msisdn2}_${Quota_Name1}_${Quota_Next_Reset_Time1};Int_1#16;Type#$PaymentType1;Float_1#${Quota_Total1}.0;Int_3#${InitialVolume1};Yes_No_1#${IsRecurring1};String_1#${Quota_Name1};String_2#6;MSISDN#${msisdn1};" >> $expected_output
