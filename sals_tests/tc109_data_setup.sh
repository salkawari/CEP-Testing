...
echo "Name#Test;Transaction_ID#${Time1}_${msisdn2}_${Quota_Name2}_${Quota_Next_Reset_Time1};Int_1#18;Type#$PaymentType1;Float_1#${Quota_Total1}.0;Int_3#0;Yes_No_1#;String_1#${Quota_Name2};String_2#6;MSISDN#${msisdn2};" >> $expected_output
