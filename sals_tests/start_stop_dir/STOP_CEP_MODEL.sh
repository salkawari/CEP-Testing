...
echo "./dfesp_xml_client -server localhost:55556 -file ${my_loc}/${CEP_MODEL_NAME}_persist.xml"
./dfesp_xml_client -server localhost:55556 -file ${my_loc}/${CEP_MODEL_NAME}_persist.xml &
sleep 1

echo "2/3) stopping the cep model.."
echo "./dfesp_xml_client -server localhost:55556 -file ${my_loc}/${CEP_MODEL_NAME}_stop.xml"
./dfesp_xml_client -server localhost:55556 -file ${my_loc}/${CEP_MODEL_NAME}_start.xml &
echo " "
sleep 1

echo "3/3) removing the cep model from memory.."
echo "./dfesp_xml_client -server localhost:55556 -file ${my_loc}/${CEP_MODEL_NAME}_remove.xml"
./dfesp_xml_client -server localhost:55556 -file ${my_loc}/${CEP_MODEL_NAME}_remove.xml &
echo " "
sleep 1
