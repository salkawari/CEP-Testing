...
################################################################################
echo "TC2: 0. CEP requirement R1: the CEP Engine delivers POSTPAID throttle 100 events with various metrics. "
...
echo " "
echo "we try various valid and invalid throttle 100 events and make sure the "
echo "good ones are cleanly processed and none are skipped (this was a bug in the CEP engine!!!!)"
echo " "
echo "EDR data setup:"
