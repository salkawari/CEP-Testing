...
echo "4912345678901,${PAYMENT_TYPE}" >> payment_type_${PAYMENT_TYPE}.txt
echo "4912345678902,${PAYMENT_TYPE}" >> payment_type_${PAYMENT_TYPE}.txt
echo "4912345678903,${PAYMENT_TYPE}" >> payment_type_${PAYMENT_TYPE}.txt
