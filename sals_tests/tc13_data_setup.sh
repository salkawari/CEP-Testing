...
throttle_file=tc13_EDR_UPCC231_MPU484_4924_40131211100031.csv
throttle_input=input_data/$throttle_file

postpaid_lkp_file=tc13_input_data_postpaid_lkp.txt
postpaid_lkp_input=input_data/$postpaid_lkp_file

recurring_lkp_file=tc13_input_data_recurring_lkp.txt
...
expected_output=$out_dir/tc13_result.expected
...
################################################################################
################################################################################
echo "tc13: 1. PCRD EDRs (input stream).."
rm -f $throttle_input
...
################################################################################
echo "tc13: 4. generating the expected output.."
...
cat $data_dir/lookup_paymenttype/tc13_input_data_postpaid_lkp.txt
echo " "
echo "here is the recurring lookup we used.."
cat $data_dir/lookup_recurring/tc13_input_data_recurring_lkp.txt
echo " "
